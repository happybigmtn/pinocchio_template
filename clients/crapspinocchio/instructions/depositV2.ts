...
export const DEPOSIT_V2_DISCRIMINATOR = 4;

export function getDepositV2DiscriminatorBytes() {
  return getU8Encoder().encode(DEPOSIT_V2_DISCRIMINATOR);
}

export type DepositV2Instruction<
...
export type DepositV2InstructionData = { discriminator: number };

export type DepositV2InstructionDataArgs = {};

export function getDepositV2InstructionDataEncoder(): Encoder<DepositV2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', getU8Encoder()]]),
    (value) => ({ ...value, discriminator: DEPOSIT_V2_DISCRIMINATOR }),
  );
}

export function getDepositV2InstructionDataDecoder(): Decoder<DepositV2InstructionData> {
  return getStructDecoder([['discriminator', getU8Decoder()]]);
}

export function getDepositV2InstructionDataCodec(): Codec<
  DepositV2InstructionDataArgs,
  DepositV2InstructionData
> {
  return combineCodec(
    getDepositV2InstructionDataEncoder(),
    getDepositV2InstructionDataDecoder(),
  );
}

export type DepositV2Input<
...
export function getDepositV2Instruction<
  TAccountTreasury extends string,
  TAccountPlayerState extends string,
  TAccountPlayerTokenAccount extends string,
  TAccountTreasuryTokenAccount extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDepositV2InstructionDataEncoder().encode({}),
  } as DepositV2Instruction<
    TProgramAddress,
    TAccountTreasury,
    TAccountPlayerState,
    TAccountPlayerTokenAccount,
...
export type ParsedDepositV2Instruction<
  TProgram extends string = typeof CRAPS_PINOCCHIO_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DepositV2InstructionData;
};

export function parseDepositV2Instruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>,
): ParsedDepositV2Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDepositV2InstructionDataDecoder().decode(instruction.data),
  };
}
