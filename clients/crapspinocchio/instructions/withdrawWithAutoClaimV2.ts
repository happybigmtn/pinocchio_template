...
export const WITHDRAW_WITH_AUTO_CLAIM_V2_DISCRIMINATOR = 7;

export function getWithdrawWithAutoClaimV2DiscriminatorBytes() {
  return getU8Encoder().encode(WITHDRAW_WITH_AUTO_CLAIM_V2_DISCRIMINATOR);
}

export type WithdrawWithAutoClaimV2Instruction<
...
export type WithdrawWithAutoClaimV2InstructionData = { discriminator: number };

export type WithdrawWithAutoClaimV2InstructionDataArgs = {};

export function getWithdrawWithAutoClaimV2InstructionDataEncoder(): Encoder<WithdrawWithAutoClaimV2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', getU8Encoder()]]),
    (value) => ({
      ...value,
      discriminator: WITHDRAW_WITH_AUTO_CLAIM_V2_DISCRIMINATOR,
    }),
  );
}

export function getWithdrawWithAutoClaimV2InstructionDataDecoder(): Decoder<WithdrawWithAutoClaimV2InstructionData> {
  return getStructDecoder([['discriminator', getU8Decoder()]]);
}

export function getWithdrawWithAutoClaimV2InstructionDataCodec(): Codec<
  WithdrawWithAutoClaimV2InstructionDataArgs,
  WithdrawWithAutoClaimV2InstructionData
> {
  return combineCodec(
    getWithdrawWithAutoClaimV2InstructionDataEncoder(),
    getWithdrawWithAutoClaimV2InstructionDataDecoder(),
  );
}

export type WithdrawWithAutoClaimV2Input<
...
export function getWithdrawWithAutoClaimV2Instruction<
  TAccountTreasury extends string,
  TAccountPlayerState extends string,
  TAccountTreasuryTokenAccount extends string,
  TAccountPlayerTokenAccount extends string,
...
>(
  input: WithdrawWithAutoClaimV2Input<
    TAccountTreasury,
    TAccountPlayerState,
    TAccountTreasuryTokenAccount,
    TAccountPlayerTokenAccount,
...
): WithdrawWithAutoClaimV2Instruction<
  TProgramAddress,
  TAccountTreasury,
  TAccountPlayerState,
  TAccountTreasuryTokenAccount,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getWithdrawWithAutoClaimV2InstructionDataEncoder().encode({}),
  } as WithdrawWithAutoClaimV2Instruction<
    TProgramAddress,
    TAccountTreasury,
    TAccountPlayerState,
    TAccountTreasuryTokenAccount,
...
export type ParsedWithdrawWithAutoClaimV2Instruction<
  TProgram extends string = typeof CRAPS_PINOCCHIO_PROGRAM_ADDRESS,
...
> = {
  ...
  data: WithdrawWithAutoClaimV2InstructionData;
};

export function parseWithdrawWithAutoClaimV2Instruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>,
): ParsedWithdrawWithAutoClaimV2Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getWithdrawWithAutoClaimV2InstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
